...
account = {
    'email': 'ayus.teke@gmail.com', 
    'passwd': 'ayush@1504'
}

# Destination config ----
SHARED_DRIVE_ID = '1yoAqH8jRE9KUGADK3GOoHKSznk0fNGlr' # team drive ID (optional) (for MyDrive, keep this field empty)
FOLDER_ID = '0AFwymmGD0ZuZUk9PVA' # drive folder ID (optional)
# ===================================================================
